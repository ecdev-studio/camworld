...
import {ICart, IFilter} from "../../types/redux-types";
...
export const clearFilter = () => {
	return {type: AppActionEnums.CLEAR_FILTER}
}

export const changeFilter = (item: IFilter) => {
	return {type: AppActionEnums.CHANGE_FILTER, payload: item}
}